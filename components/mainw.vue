     ...
     <div class="main-text-wrapper">
       <h1>Вашей жизни мешает ПТСР, это приводит к разложению жизни?
        <br>Предлагаю вам избавиться от психотравм полученных при изнасилований</h1>
		 <p>Настало время <strong>перестать</strong> страдать и терпеть от посттравматического синдромного расстройства, полученного детстве, психотравмы, которые не дают вам жить счастливой жизнью!<br> 
Я гарантированно избавлю вас от внутренних конфликтов, влияющего на пережившее в детстве, уничтожающие вашу жизнь! <br>
</p>
       <div class="buttons">

    ...
    <div class="konsultatsia-content">
       <div class="konsultatsia-wrap content">
        <div class="konsultatsia-title title">   
            <h3>Моя авторская программа "Терапия изменения жизни" уже помогла многим людям, чья жизнь зашла в тупик. Они снова обрели свободу, стали чувствовать партнера в семейной жизни, нашли свое призвание и живут счастливо!</h3>
        </div>
...
<style>
    ...
    .recvisit{
        ...
        border-bottom: 3px solid #41cb52;
    ...
    .recvisit-box-information{
        font-size: 16px;
        color: #616161;
    }
    @media (max-width: 767px) {
        div.konsultatsia-title h3{
            font-size: calc(17px + (19 + 19 * 0.7) * ((100vw - 320px) / 1280)) !important;
            margin: 0 0 10px;
        }
        div .main-button-continue-2{
            margin-top: 40px;
